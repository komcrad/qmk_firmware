...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  CW_TOGG,  KC_LCTL,  KC_LALT, KC_LGUI,  LOWER,   MT(MOD_LCTL, KC_SPC),  MT(MOD_LCTL, KC_SPC),  RAISE,   TO(_VIM), KC_DOWN, KC_RCTL, CW_TOGG
),
...
[_VIM] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______,
  _______, _______, NXTWORD, _______, _______, _______, _______, _______, TO(_QWERTY), _______, _______, _______,
